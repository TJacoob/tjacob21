		...
		<div class="container">
			<div class="grid grid-cols-1 gap-24 lg:gap-10 mt-8 lg:mt-8 mb-4">
				<div v-for="work of works" :key="work.slug" class="flex flex-col lg:flex-row bg-white rounded-3xl shadow-md lg:ml-12">
					<img class="inline w-32 h-32 rounded-full border-2 border-primary-lighter bg-white mx-auto sm:ml-0 lg:mx-auto -mt-20 lg:-ml-16 lg:my-auto"
						 :src="require(`~/static/images/${work.logo}`)"
						 :alt="work.company"
					/>
					<div class="px-5 pt-3 pb-8 lg:pt-5 lg:pb-6">
						<h2 class="inline text-primary font-semibold text-xl">
							{{ work.position }}
							<a :href="work.website" target="_blank" rel="nofollow noopener noreferrer" class="font-light hover:text-primary-lighter transition duration-200">@ {{ work.company }}</a>
						</h2>
