		...
		<div class="container h-full">
			<div class="lg:flex pt-12 pb-12 lg:mb-3 lg:pb-0 lg:pt-8 h-full -mt-20">
				...
				<div class="w-full lg:w-2/5 my-auto">
					...
					<a href="/files/CV_2022.pdf" target="_blank" class="flex rounded-lg py-5 px-6 shadow-md bg-gradient-to-tr from-primary to-primary-lighter text-white hover:bg-white hover:from-white hover:to-white hover:text-primary transition duration-200 mb-8 lg:mb-0">
